...
public class SplashActivity extends BaseActivity {
    ...
    private final int LOADMAINUI = 0;
    private final int SECONDEPAGE = LOADMAINUI+1;
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case LOADMAINUI:
                    if (!isInterrupt){
                        SplashCntroller.loadMainUi(SplashActivity.this);
                    }
                    break;
                case SECONDEPAGE:
                    //展示第二张图
                    if(secondPage != null){
                        ...
                        AppConfigEntity loadingInfo = SharedPreferencesUtils.getLoadingInfo(getContext());
...
//                responseObject.setAppUrl(downloadUrl);
                isInterrupt = SplashCntroller.dealUpdate(getContext()
                        ,(CheckUpdateResponseEntity) httpContext.getResponseObject()
                        , (UpdateProgressDialogView) findViewById(R.id.updv_splash_pb)
                        ,true);
            }
    ...
    public void onHttpRequestComplete(String url, HttpContext httpContext) {
        ...
        LogUtil.zLog().e("onHttpRequestComplete");
    }
