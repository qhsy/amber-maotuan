...
import com.ichsy.hrys.common.view.refreshview.util.PtrCLog;
 ...
 * 下拉刷新自定义控件，只能有俩个view，header和content
 * header通常会实现ptrUIHandler
 * content为任意View
 * 通过重写onFinishInflate、onMeasure、onLayout确定控件大小和位置
 * 通过重写dispatchTouchEvent确定控件下拉行为
 */
public class PtrFrameLayout extends ViewGroup {
    ...
    private boolean isAllowPrt=true;
    public void setAllowPrt(boolean isAllowPrt){
        this.isAllowPrt = isAllowPrt;
    }
    public boolean isAllowPrt(){
        return isAllowPrt;
    }
